...
#define BREAKOUT_CS     5 //32     // VS1053 chip select pin (output)
#define BREAKOUT_DCS    32 //33    // VS1053 Data/command select pin (output)

// DREQ should be an Int pin, see http://arduino.cc/en/Reference/attachInterrupt
#define DREQ 4 //35       // VS1053 Data request, ideally an Interrupt pin

Adafruit_VS1053_FilePlayer player = Adafruit_VS1053_FilePlayer(0 , BREAKOUT_CS, BREAKOUT_DCS, DREQ, 0);
